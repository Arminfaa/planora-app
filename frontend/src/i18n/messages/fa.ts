...
export const faMessages = {
  ...
  projects: {
    ...
    personCompletionsSubtitle:
      'تعداد تسک‌های تکمیل‌شده روزانه برای عضو انتخابی در بازه زمانی. روزهای تعطیل و مرخصی دیده می‌شوند ولی در میانگین حساب نمی‌شوند.',
    ...
    personCompletionsLegendWorking: 'روز کاری',
